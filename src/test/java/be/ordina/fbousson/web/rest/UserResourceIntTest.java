package be.ordina.fbousson.web.rest;

import be.ordina.fbousson.FreddydemoApp;
import be.ordina.fbousson.domain.Authority;
import be.ordina.fbousson.domain.User;
import be.ordina.fbousson.repository.UserRepository;
import be.ordina.fbousson.repository.search.UserSearchRepository;
import be.ordina.fbousson.security.AuthoritiesConstants;
import be.ordina.fbousson.service.MailService;
import be.ordina.fbousson.service.UserService;
import be.ordina.fbousson.service.dto.UserDTO;
import be.ordina.fbousson.service.mapper.UserMapper;
import be.ordina.fbousson.web.rest.errors.ExceptionTranslator;
import be.ordina.fbousson.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = FreddydemoApp.class)
